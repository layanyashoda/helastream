const HeaderLogoMobileOnly: React.FC<{ className?: string }> = ({
    className = "",
}) => {
    return (
        <svg
            ...
            viewBox="0 0 76 76"
            aria-labelledby="company-logo-only-svg"
            role="img"
            width="32"
            height="32"
            fill="none"
        >
            ...
            <path
                className="fill-[#FF0000] transition-colors duration-300 group-hover:fill-white"
...
const HeaderLogoLarge: React.FC<{ className?: string }> = ({
    className = "",
}) => {
    return (
        <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 460 76"
            aria-labelledby="company-horizontal-svg"
            role="img"
            width="145"
            height="36"
            fill="none"
...
export { HeaderLogoMobileOnly, HeaderLogoLarge };
