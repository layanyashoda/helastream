...
export default function LandingPage() {
  return (
    <div className="bg-[#141519] min-h-screen text-white">
      {/* Hero Section */}
      <section className="relative h-[85vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link href="/discover">
              <button className="bg-[var(--app-background-crunchyroll-orange)] hover:bg-[#ff3333] text-black font-bold text-lg px-10 py-4 uppercase tracking-widest clip-path-polygon transition-transform hover:scale-105">
                Start Watching Free
              </button>
            </Link>
            <Link href="/premium">
              <button className="bg-transparent border-2 border-white hover:bg-white hover:text-black text-white font-bold text-lg px-10 py-4 uppercase tracking-widest transition-all">
                Go Premium
              </button>
            </Link>
          </div>
