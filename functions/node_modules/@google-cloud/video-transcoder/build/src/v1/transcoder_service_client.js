...
exports.TranscoderServiceClient = void 0;
 ...
 */
const gapicConfig = require("./transcoder_service_client_config.json");
...
class TranscoderServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            jobTemplatePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/jobTemplates/{job_template}'),
        ...
        this.descriptors.page = {
            ...
            listJobTemplates: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'jobTemplates'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.video.transcoder.v1.TranscoderService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.transcoderServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.video.transcoder.v1.TranscoderService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.video.transcoder.v1
                    .TranscoderService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of transcoderServiceStubMethods) {
            const callPromise = this.transcoderServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createJobTemplate(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getJobTemplate(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteJobTemplate(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listJobTemplates(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listJobTemplatesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listJobTemplates.createStream(this.innerApiCalls.listJobTemplates, request, callSettings);
    }
    /**
    ...
    listJobTemplatesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listJobTemplates.asyncIterate(this.innerApiCalls['listJobTemplates'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.TranscoderServiceClient = TranscoderServiceClient;
//# sourceMappingURL=transcoder_service_client.js.map